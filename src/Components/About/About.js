...
const About = () => {
    return (
        <div className='mt-28 mb-20'>
            ...
            <p className='font-medium text-justify mt-9 lg:px-64 sm:px-32 text-xl'>We are a leading Software Development Company and IT service provider that specializes in
...
support every step of the way</p>
           ...
           <div>
            ...
            <p className='font-medium text-justify mt-10 lg:px-64 sm:px-32  text-xl'>Our mission is to provide scalable IT solutions to our customers at an unbeatable price, without
...
by providing affordable, effective design/development and marketing solutions.
           ...
           <div>
            ...
            <p className='font-medium text-justify mt-10 lg:px-64 sm:px-32  text-xl'>Our vision is to become a global leader in providing the best and unique design, development
